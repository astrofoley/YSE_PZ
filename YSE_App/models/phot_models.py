...
class TransientPhotData(PhotData):
    class Meta:
        indexes = [
            models.Index(fields=['photometry', 'obs_date'], name='yse_tphot_obs_idx'),
            models.Index(fields=['photometry', 'discovery_point', 'obs_date'], name='yse_tphot_disc_idx'),
        ]
...
class HostPhotData(PhotData):
    class Meta:
        indexes = [
            models.Index(fields=['photometry', 'obs_date'], name='yse_hphot_obs_idx'),
        ]
