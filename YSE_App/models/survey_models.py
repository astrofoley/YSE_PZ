...
class SurveyField(BaseModel):
	...
	class Meta:
		indexes = [
			models.Index(fields=['field_id'], name='yse_sfield_id_idx'),
			models.Index(fields=['ra_cen', 'dec_cen'], name='yse_sfield_radec_idx'),
			models.Index(fields=['obs_group', 'instrument', 'active'], name='yse_sfield_scope_idx'),
		]
...
class SurveyObservation(BaseModel):
	...
	class Meta:
		indexes = [
			models.Index(fields=['survey_field', 'obs_mjd'], name='yse_sobs_field_obs_idx'),
			models.Index(fields=['survey_field', 'mjd_requested'], name='yse_sobs_field_req_idx'),
		]
