...
class Transient(BaseModel):
	...
	class Meta:
		indexes = [
			models.Index(fields=['name'], name='yse_trans_name_idx'),
			models.Index(fields=['disc_date'], name='yse_trans_disc_idx'),
			models.Index(fields=['ra', 'dec'], name='yse_trans_radec_idx'),
			models.Index(fields=['status', 'disc_date'], name='yse_trans_stat_disc_idx'),
		]
